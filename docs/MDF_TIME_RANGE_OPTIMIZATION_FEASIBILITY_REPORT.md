...
[`_compute_global_time_range()`](file:///Users/demo/CSV_Plot_PySide/src/data/mdf_lazy_loader.py#L256-L280) 当前在每个 Group 上执行：
...
经验证，当前项目依赖 `asammdf>=7.4.0`（[pyproject.toml](file:///Users/demo/CSV_Plot_PySide/pyproject.toml#L8)），该版本明确支持以下参数：
...
| 调用方文件 | 使用方式 | 是否受影响 |
|------------|---------|:---:|
| [`cursor_sync_manager.py`](file:///Users/demo/CSV_Plot_PySide/src/ui/cursor_sync_manager.py#L268-L449) | 光标同步、密度计算、plot 重绘 | ❌ 不受影响 |
| [`plot_data_manager.py`](file:///Users/demo/CSV_Plot_PySide/src/ui/widgets/plot_data_manager.py#L490-L516) | X 轴范围计算、padding | ❌ 不受影响 |
| [`layout_manager.py`](file:///Users/demo/CSV_Plot_PySide/src/ui/layout_manager.py#L326) | 时间修正后的范围重算 | ❌ 不受影响 |
| [`file_loader_manager.py`](file:///Users/demo/CSV_Plot_PySide/src/ui/file_loader_manager.py#L35-L41) | 有效性检查 | ❌ 不受影响 |
