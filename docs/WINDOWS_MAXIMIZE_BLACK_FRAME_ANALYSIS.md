...
③ Qt 收到 WM_SIZE → QMainWindow.resizeEvent(event) 
   [csv_plot.py:4612](file:///Users/demo/CSV_Plot_PySide/csv_plot.py#L4612)
         ↓
...
⑤ self.layout_manager._handle_resize(event) → QTimer.singleShot(0, ...)
   [layout_manager.py:L75-L83](file:///Users/demo/CSV_Plot_PySide/src/ui/layout_manager.py#L75-L83)
...
1. [central widget 创建](file:///Users/demo/CSV_Plot_PySide/csv_plot.py#L4345) — 未设置背景色
   ```python
   central = QWidget()
   self.setCentralWidget(central)
   ```

2. [resizeEvent](file:///Users/demo/CSV_Plot_PySide/csv_plot.py#L4612-L4614) — 入口
   ```python
...
3. [_handle_resize](file:///Users/demo/CSV_Plot_PySide/src/ui/layout_manager.py#L75-L83) — 将 splitter 修正延迟到下一事件循环
   ```python
