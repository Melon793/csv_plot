...
> **问题文件**: `/data/DEMO21 PHEV ADP _20%SOC _EGROPEN_20260422.mf4`  
...
已编写完整的通道加载与诊断脚本：[scripts/diagnose_mdf_channel.py](file:///Users/demo/CSV_Plot_PySide/scripts/diagnose_mdf_channel.py)
...
通过诊断程序从文件 `/data/DEMO21 PHEV ADP _20%SOC _EGROPEN_20260422.mf4` 中加载并分析 `Epm_nEng_VW` 通道，结果如下：
...
**文件**: [src/data/metadata.py:L58-62](file:///Users/demo/CSV_Plot_PySide/src/data/metadata.py#L58-L62)
...
**文件**: [src/data/mdf_lazy_loader.py:L440-447](file:///Users/demo/CSV_Plot_PySide/src/data/mdf_lazy_loader.py#L440-L447)
...
**文件**: [src/data/metadata.py:L62](file:///Users/demo/CSV_Plot_PySide/src/data/metadata.py#L62)
...
**文件**: [scripts/build_exe_nuitka.bat](file:///Users/demo/CSV_Plot_PySide/scripts/build_exe_nuitka.bat)
