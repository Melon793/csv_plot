...
class TestFilePathCopy:
    ...
    ``//cnn002/bo-test-extend/… TC01_ EU7 Calibration/…1am=0.8_Map.csv``
    ...
    RAW = (
        "//cnn002/bo-test-extend/P26-OM25838-02_Chery_H415_TC01_ EU7 Calibration"
        "/20260706_CHERY_H4G15_1am=0.8_Map.csv"
    )
    WIN = RAW.replace("/", "\\")
