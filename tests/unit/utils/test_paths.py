...
UNC_POSIX = (
    "//cnn002/bo-test-extend/P26-OM25838-02_Chery_H4G15_TC01_ EU7 Calibration"
    "/b_Technics/c_Testing/04_Test_Result/OBM_Mapping"
    "/20260706_CHERY_H4G15_1am=0.8_Map/20260706_CHERY_H4G15_1am=0.8_Map.csv"
)
...
class TestNormalizeInputPath:
    def test_windows_unc_normalized(self, monkeypatch):
        ...
        这是本功能的根因用例：拖拽给的 '//cnn002/share/a b.csv' 经
        ``os.path.abspath`` 必须得到 '\\\\cnn002\\\\share\\\\a b.csv'。
        """
        monkeypatch.setattr(paths, "_native_abspath", ntpath.abspath)
        out = normalize_input_path("//cnn002/share/a b.csv")
        assert out == "\\\\cnn002\\share\\a b.csv"
...
class TestShellQuoting:
    @pytest.mark.parametrize(
        "path",
        [
            r"\\cnn002\share\a b.csv",  # 空格（用户实测路径）
            r"\\cnn002\share\1am=0.8.csv",  # 等号
