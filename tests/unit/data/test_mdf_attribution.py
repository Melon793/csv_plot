...
HD_TEXT = (
    "<HDcomment><TX>Database: FAWVW_DHE15\r\n"
    "Experiment: FEV_2\r\n"
    "Workspace: Workspace\r\n"
    "Devices: XCP:1,CAN-Monitoring:1,CalcDev\r\n"
    "Program Description: LECPF21_AR_D3p2, HE15GT_AA_All_14_DBC\r\n"
    "WP: FEV_0116_TJ_Freeze_1\r\n"
    "RP: FEV_0116_TJ_Freeze_0\r\n"
    "Date: 05/09/2026\r\n"
    "Time: 01:36:14 PM\r\n"
...
class TestHdComment:
    def test_parse_hd_comment(self):
        ...
        assert parsed["Experiment"] == "FEV_2"
        assert parsed["Program Description"] == "LECPF21_AR_D3p2, HE15GT_AA_All_14_DBC"
